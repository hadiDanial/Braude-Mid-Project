...
CREATE TABLE `branch_workers` (
  ...
  CONSTRAINT `branch_workers_ibfk_1` FOREIGN KEY (`branchId`) REFERENCES `branches` (`branchId`),
  CONSTRAINT `branch_workers_ibfk_2` FOREIGN KEY (`workerId`) REFERENCES `users` (`userId`)
...
-- Dump completed on 2022-06-10  2:58:54
