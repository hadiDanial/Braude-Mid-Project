...
CREATE TABLE `discounts_products` (
  ...
  PRIMARY KEY (`catalogId`,`branchId`,`discountId`),
  KEY `discountId` (`discountId`),
  CONSTRAINT `discounts_products_ibfk_1` FOREIGN KEY (`catalogId`, `branchId`) REFERENCES `catalogiteminbranch` (`catalogId`, `branchId`),
  CONSTRAINT `discounts_products_ibfk_2` FOREIGN KEY (`discountId`) REFERENCES `discounts` (`discountId`)
