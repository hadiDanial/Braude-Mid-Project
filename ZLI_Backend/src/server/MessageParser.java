...
// * @throws Exception
// */
// public static void parseMessage(Object msg, ConnectionToClient client) throws
// Exception {
...
// Order order = new Order((int) data.get("orderID"), (float)
// data.get("totalCost"),
// (String) data.get("greetingCard"),
// (String) data.get("color"), (String) data.get("dOrder"), (String)
// data.get("branch"),
...
// DBController.updateColorDateOrderInDB(data.get("orderID").toString(),
// (String) data.get("color"),
// (String) data.get("orderDate"));
// break;
// case "UPDATE_ORDER_DATE_IN_DB":
// DBController.updateDateOrderInDB(data.get("orderID").toString(), (String)
// data.get("orderDate"));
// break;
// case "UPDATE_ORDER_COLOR_IN_DB":
// DBController.updateColorOrderInDB(data.get("orderID").toString(), (String)
// data.get("color"));
// break;
// default:
// break;
...
// * @param message
// */
// public static void generateMessage(String command, Object data,
